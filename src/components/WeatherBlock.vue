<template>
  <div class="weather-block">
    <div class="current-weather" v-if="current">
      <img :src="`/weather-icons/${weatherCodeImage}.png`" />
      <div>
        <h1>{{current.data.values.temperature}}°C</h1>
        <p>
          {{current.data.values.temperature}}°C / 
          {{current.data.values.temperature}}°C
        </p>
      ...
      <div>
        ...
        <div class="current-humidity">
          💧
          {{ current.data.values.humidity }}%
        </div>
        <div class="current-precipitation">
          ☔️
          {{current.data.values.precipitationProbability}}%
        </div>
...
<div>
  ...
  <div class="aqi-indicator__root--ucJ5 air-pollution-widget__aqi--VV9D">
    <div class="aqi-indicator__container--DGbQ air-pollution-widget__aqi-container--cikN">
      <div class="aqi-indicator__name--ZLbF"><span
          class="aqi-indicator__title--aROO air-pollution-widget__aqi-title--pDI2"
          title="Qualité de l'air"><span>Qualité de l'air</span><span
            class="aqi-indicator__short-title-text--RMTH">IQA</span><a
            href="https://www.tomorrow.io/weather/CH/BE/Biel%2FBienne/017526/health/" target="_blank"
            rel="noopener noreferrer"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16.001 16.001"
              class="aqi-indicator__info-icon--J4+d air-pollution-widget__aqi-info-icon--HKZS">
              <path
                d="M8.001 16.001a8 8 0 118-8 8.009 8.009 0 01-8 8zm0-10a1 1 0 00-1 1v5a1 1 0 002 0v-5a1 1 0 00-1-1zm0-3a1 1 0 101 1 1 1 0 00-1-1z"
                fill="#abb0b4"></path>
            </svg></a></span><span class="aqi-indicator__aqi-value--nH9c air-pollution-widget__aqi-value--ZhRy">
          <div class="aqi-indicator__number-value--46Qh"><b>37</b>/500</div>
          <div class="aqi-indicator__verbal-value--C9zD" title="Bonne">Bonne</div>
        </span></div>
      <div class="horizontal-scale__root--P2Gc air-pollution-widget__aqi-hor-scale--KdKi">
        <div class="horizontal-scale__scale--ap7f air-pollution-widget__aqi-scale--wTIT">
          <div class="horizontal-scale__inner-scale--WdsS" style="width: 7.4%;">
            <div class="horizontal-scale__indicator-scale--1KmC" style="width: 159.641px;"></div>
          </div>
        </div>
        <div class="horizontal-scale__indexes--M4Wn air-pollution-widget__aqi-indexes--tycE">
          <span>0</span><span>100</span><span>200</span><span>300</span><span>400</span><span>500</span></div>
        <div class="horizontal-scale__short-indexes--3v2i air-pollution-widget__aqi-short-indexes--LKGQ">
          <span>0</span><span>250</span><span>500</span></div>
      </div>
      <div class="vertical-scale__root--SS1x aqi-indicator__vertical--Nn3S">
        <div class="vertical-scale__scale--SgyC">
          <div class="vertical-scale__inner-scale--r9Uf" style="height: 7.4%;">
            <div class="vertical-scale__indicator-scale--r24N" style="height: 0px;"></div>
          </div>
        </div>
        <div class="vertical-scale__indexes--BZpz">
          <span>0</span><span>100</span><span>200</span><span>300</span><span>400</span><span>500</span></div>
      </div>
    </div>
  </div>

  <div class="aqi-pollen-widget__pollen--a+Oj"><span class="aqi-pollen-widget__pollen-title--PNKK"
      title="Pollen">Pollen</span>
    <div class="static-pollen__root--Yk49 aqi-pollen-widget__static-pollen--3LDL">
      <div class="static-pollen-indicator__root--L+y5 aqi-pollen-widget__pollen-scale-container--9Lqq">
        <div class="pollen-label__root--8bBj aqi-pollen-widget__pollen-label-container--iPEZ">
          <div class="pollen-label__label--NNSK aqi-pollen-widget__pollen-label--Bjc0" title="Arbre">Arbre</div>
          <div class="pollen-label__value--OYD6 aqi-pollen-widget__pollen-value--AauX"><span>2</span>/<span>5</span>
          </div>
        </div>
        <div
          class="pollen-scale__root--o528 static-pollen-indicator__scale--bG7D aqi-pollen-widget__pollen-scale--SU-z">
          <div class="pollen-scale__line--bkz3"
            style="width: 40%; background-color: rgb(235, 167, 47); margin-left: 0px;"></div>
          <div class="pollen-scale__indicator-line--MpZV"></div>
          <div class="pollen-scale__indexes--zm9T"><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">0</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">1</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">2</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">3</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">4</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">5</span></div>
        </div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.872 40"
          class="static-pollen-indicator__icon--+h-R">
          <path
            d="M14.436 0a7.723 7.723 0 017.633 6.554l.029.219.22.029a7.723 7.723 0 016.548 7.337l.006.3a7.666 7.666 0 01-1.214 4.146l-.019.024.09.163a9.876 9.876 0 011.133 4.176l.01.444a9.949 9.949 0 01-13.247 9.4v5.2h4.682a1.006 1.006 0 01.137 2l-.138.008H8.932a1.006 1.006 0 01-.137-2l.137-.009h4.68v-5.342a9.866 9.866 0 01-2.777.661l-.437.029-.44.01A9.941 9.941 0 011.143 18.78l.091-.166-.227-.375a7.663 7.663 0 01-1-3.432L0 14.436A7.722 7.722 0 016.554 6.8l.219-.029.03-.219A7.723 7.723 0 0114.14.006zm0 2.012a5.708 5.708 0 00-5.709 5.709 1.006 1.006 0 01-1.006 1.006 5.7 5.7 0 00-4.5 9.214A1.006 1.006 0 013.28 19.1a8.054 8.054 0 00-1.268 4.29 7.935 7.935 0 0011.92 6.874l-.32.173V26.29L8.5 21.177a1.006 1.006 0 011.31-1.52l.113.1 3.691 3.692v-3.2a1.006 1.006 0 012-.137l.009.137v3.2l3.593-3.59a1.006 1.006 0 011.31-.1l.113.1a1.006 1.006 0 01.1 1.31l-.1.113-5.016 5.015v4.327a7.866 7.866 0 002.866.708l.421.011A7.937 7.937 0 0025.6 19.1a1.006 1.006 0 01.053-1.163 5.7 5.7 0 00-4.5-9.213 1.006 1.006 0 01-1.006-1.006 5.709 5.709 0 00-5.711-5.706zm.338 4.759a5.207 5.207 0 013.264 3.8l.025.143.206.041a5.2 5.2 0 013.436 2.582l.129.252a1.006 1.006 0 01-1.815.869 3.188 3.188 0 00-2.878-1.814 1.006 1.006 0 01-1.006-1.006 3.193 3.193 0 00-2.069-2.988 1.006 1.006 0 01.707-1.884z"
            fill="#eba72f" fill-rule="evenodd"></path>
        </svg>
      </div>
      <div class="static-pollen-indicator__root--L+y5 aqi-pollen-widget__pollen-scale-container--9Lqq">
        <div class="pollen-label__root--8bBj aqi-pollen-widget__pollen-label-container--iPEZ">
          <div class="pollen-label__label--NNSK aqi-pollen-widget__pollen-label--Bjc0" title="Plante">Plante</div>
          <div class="pollen-label__value--OYD6 aqi-pollen-widget__pollen-value--AauX"><span>0</span>/<span>5</span>
          </div>
        </div>
        <div
          class="pollen-scale__root--o528 static-pollen-indicator__scale--bG7D aqi-pollen-widget__pollen-scale--SU-z">
          <div class="pollen-scale__line--bkz3" style="width: 0%; background-color: rgb(3, 205, 94); margin-left: 2px;">
          </div>
          <div class="pollen-scale__indicator-line--MpZV"></div>
          <div class="pollen-scale__indexes--zm9T"><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">0</span><span
              ...
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">4</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">5</span></div>
        </div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.251 40"
          class="static-pollen-indicator__icon--+h-R">
          <path
            d="M14.825 0a1.209 1.209 0 011.2 1.045l.011.164v7.246a9.306 9.306 0 016.909-3.065h.172a1.209 1.209 0 011.209 1.21v.172a9.331 9.331 0 01-8.292 9.273v21.536h2.939V23.565a1.209 1.209 0 012.407-.164l.011.164v2.452a7.9 7.9 0 015.509-2.229h.143A1.209 1.209 0 0128.251 25v.143a7.927 7.927 0 01-6.861 7.854v4.586h3.719a1.209 1.209 0 01.164 2.407l-.165.01H3.863a1.209 1.209 0 01-.164-2.407l.164-.011h4.43v-8a9.33 9.33 0 01-8.287-8.915L0 20.306v-.172a1.209 1.209 0 011.209-1.209l.53.007a9.306 9.306 0 016.555 3.058v-3.362a1.209 1.209 0 012.407-.164l.011.164v18.953h2.9V1.209A1.209 1.209 0 0114.825 0zM25.7 26.337l-.266.065a5.52 5.52 0 00-3.847 3.848l-.065.265.267-.065a5.518 5.518 0 003.847-3.85zm-23.19-4.9l.031.183a6.917 6.917 0 005.473 5.473l.182.029-.03-.181a6.921 6.921 0 00-5.474-5.474zM21.813 7.9l-.181.032a6.921 6.921 0 00-5.474 5.474l-.031.182.182-.03a6.919 6.919 0 005.474-5.474z"
            fill="#03cd5e" fill-rule="evenodd"></path>
        </svg>
      </div>
      <div class="static-pollen-indicator__root--L+y5 aqi-pollen-widget__pollen-scale-container--9Lqq">
        <div class="pollen-label__root--8bBj aqi-pollen-widget__pollen-label-container--iPEZ">
          <div class="pollen-label__label--NNSK aqi-pollen-widget__pollen-label--Bjc0" title="Herbe">Herbe</div>
          <div class="pollen-label__value--OYD6 aqi-pollen-widget__pollen-value--AauX"><span>0</span>/<span>5</span>
          </div>
        </div>
        <div
          class="pollen-scale__root--o528 static-pollen-indicator__scale--bG7D aqi-pollen-widget__pollen-scale--SU-z">
          <div class="pollen-scale__line--bkz3"
            style="width: 0%; background-color: rgb(45, 152, 82); margin-left: 2px;"></div>
          <div class="pollen-scale__indicator-line--MpZV"></div>
          <div class="pollen-scale__indexes--zm9T"><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">0</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">1</span><span
              ...
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">4</span><span
              class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">5</span></div>
        </div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.145 19.346"
          class="static-pollen-indicator__icon--+h-R">
          <path
            d="M9.508.174l.07.067.362.391A23.08 23.08 0 0113.965 6.7a29.105 29.105 0 013.059-5.659.739.739 0 011.341.509 78.248 78.248 0 00-.553 10.573 25.97 25.97 0 012.631-3.81l.374-.441.8-.926a.74.74 0 011.282.636l-.028.1-.628 1.77a16.048 16.048 0 00-.643 8.419h.8a.739.739 0 01.1 1.471l-.1.007H1.58a.739.739 0 01-.1-1.471l.1-.007h.646l.008-.176A22.366 22.366 0 00.856 9.239l-.194-.505-.605-1.523a.739.739 0 011.212-.794A25.786 25.786 0 015 11.193a53.71 53.71 0 00-2.532-9.1l-.276-.72-.138-.355a.739.739 0 011.169-.83 28.887 28.887 0 016.1 7.277 32.825 32.825 0 00-.854-5.892l-.125-.525L8.312.92A.74.74 0 019.508.174zM2.847 10.6l.049.174a23.838 23.838 0 01.815 7v.1h2.106v-.058q-.063-1.049-.166-2.094l-.023-.039-.59-1.283a24.33 24.33 0 00-1.946-3.45zm17.421.4l-.116.167a24.025 24.025 0 00-1.986 3.529l-.233.528-.014.024.12 2.628H20.1a17.486 17.486 0 01.126-6.7zM4.536 3.5l.108.321a55.309 55.309 0 012.649 13.942v.109h4.223A27.414 27.414 0 004.683 3.653zm12.039 1.112l-.041.078a27.78 27.78 0 00-3.058 9.835l-.058.545-.269 2.8h3.411l-.151-3.3a79.545 79.545 0 01.083-8.805zm-6.207-1.13l.081.489a25.765 25.765 0 01.319 5.991l-.022.236a28.9 28.9 0 011.338 3.547 29.169 29.169 0 011.13-4.979l.038.1A21.6 21.6 0 0010.531 3.7z"
            fill="#2d9852" fill-rule="evenodd"></path>
        </svg>
      </div>
    </div>
    <div class="animated-pollen__root--PZEE aqi-pollen-widget__animated-pollen--zAoP">
      <div class="animated-pollen-indicator__root--ghDw">
        <div class="pollen-label__root--8bBj">
          <div class="pollen-label__label--NNSK aqi-pollen-widget__pollen-label--Bjc0" title="Arbre">Arbre</div>
          <div class="pollen-label__value--OYD6 aqi-pollen-widget__pollen-value--AauX"><span>2</span>/<span>5</span>
          </div>
        </div>
        <div class="animated-pollen-indicator__pollen--N2zC">
          <div class="animated-pollen-indicator__animation--p5IM"><img
              src="https://weather-website-client.tomorrow.io/img/pollution/flying-tree.gif" alt="tree"></div>
          <div class="pollen-scale__root--o528 aqi-pollen-widget__pollen-scale--SU-z">
            <div class="pollen-scale__line--bkz3"
              style="width: 40%; background-color: rgb(235, 167, 47); margin-left: 0px;"></div>
            <div class="pollen-scale__indicator-line--MpZV"></div>
            <div class="pollen-scale__indexes--zm9T"><span
      ...
      <div class="animated-pollen-indicator__root--ghDw">
        ...
        <div class="animated-pollen-indicator__pollen--N2zC">
          <div class="animated-pollen-indicator__animation--p5IM"><img
              src="https://weather-website-client.tomorrow.io/img/pollution/flying-weed.gif" alt="weed"></div>
          <div class="pollen-scale__root--o528 aqi-pollen-widget__pollen-scale--SU-z">
            <div class="pollen-scale__line--bkz3"
              style="width: 0%; background-color: rgb(3, 205, 94); margin-left: 2px;"></div>
            <div class="pollen-scale__indicator-line--MpZV"></div>
            <div class="pollen-scale__indexes--zm9T"><span
                class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">0</span><span
                class="pollen-scale__index--xNhw aqi-pollen-widget__pollen-index---S8q">1</span><span
      ...
      <div class="animated-pollen-indicator__root--ghDw">
        ...
        <div class="animated-pollen-indicator__pollen--N2zC">
          <div class="animated-pollen-indicator__animation--p5IM"><img
              src="https://weather-website-client.tomorrow.io/img/pollution/flying-grass.gif" alt="grass"></div>
          <div class="pollen-scale__root--o528 aqi-pollen-widget__pollen-scale--SU-z">
            <div class="pollen-scale__line--bkz3"
              style="width: 0%; background-color: rgb(45, 152, 82); margin-left: 2px;"></div>
            <div class="pollen-scale__indicator-line--MpZV"></div>
...
const current: Ref<RealTimeWeather | null> = ref({
  "data": {
...
const forecast: Ref<unknown> = ref({
  "timelines": {
    "minutely": [
      {
...
async function getForecast() {
  try {
    const response = await fetch(`https://api.tomorrow.io/v4/weather/forecast?location=Lausanne&apikey=${weatherApiKey.value}&timesteps=1d&units=metric`)
